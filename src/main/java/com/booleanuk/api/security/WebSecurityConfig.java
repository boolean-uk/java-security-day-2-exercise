    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers(HttpMethod.GET, "/items", "/users", "/users/*/history").authenticated()
                        .requestMatchers("/lends/return", "/lends/borrow").authenticated()
                        .requestMatchers("/items/**", "/users/**", "/lends/**").hasRole("MODERATOR")
